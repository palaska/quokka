...
from pyquokka.types import CatalogTableId, ICatalog, INode, NodeId, Schema, SourceDataStreamIndex, StageId, TaskGraphNodeId
...
class InputS3CSVNode(SourceNode):
    def __init__(self, bucket, prefix, key, schema: Schema, sep, has_header, projection = None) -> None:
        super().__init__(schema)
        self.bucket = bucket
        self.prefix = prefix
        self.key = key
...
class InputRestGetAPINode(SourceNode):
    def __init__(self, url, arguments, headers, schema: Schema, batch_size = 10000) -> None:
        super().__init__(schema)
        self.url = url
...
class InputDiskCSVNode(SourceNode):
    def __init__(self, filename, schema: Schema, sep, has_header, projection = None) -> None:
        super().__init__(schema)
...
class InputLanceNode(SourceNode):
    def __init__(self, uris, schema: Schema, vec_column, predicate = None, projection = None) -> None:
        super().__init__(schema)
        self.uris = uris
        self.predicate = predicate
        self.projection = projection
...
class InputS3ParquetNode(SourceNode):
    def __init__(self, files, schema: Schema, predicate = None, projection = None, nthreads = 4, name_column = None) -> None:
        super().__init__(schema)
...
class InputDiskParquetNode(SourceNode):
    def __init__(self, filepath, schema: Schema, predicate = None, projection = None) -> None:
        super().__init__(schema)
...
'''
class TaskNode(Node):
    def __init__(self, schema: Schema, schema_mapping: dict, required_columns: set) -> None:
        super().__init__(schema)
...
class JoinNode(TaskNode):
    def __init__(self, schema: Schema, schema_mapping, required_columns, join_spec, assume_sorted = {}) -> None:
...
class BroadcastJoinNode(TaskNode):
    def __init__(self, schema: Schema, schema_mapping, required_columns, operator, assume_sorted = {}) -> None:
        """
        Args:
...
class MapNode(TaskNode):
    def __init__(self, schema: Schema, schema_mapping, required_columns, function, foldable = True) -> None:
        super().__init__(schema, schema_mapping, required_columns)
...
class NearestNeighborFilterNode(TaskNode):
    ...
    def __init__(self, schema: Schema, schema_mapping: dict, vec_column: str, probe_df, probe_vector_col: str, k: int) -> None:
        super().__init__(
            schema = schema,
