...
from pyquokka.types import ColumnName, IPartitioner
...
class TargetInfo:
    def __init__(self, partitioner: Partitioner, predicate: sqlglot.Expression, projection: Optional[Iterable[ColumnName]], batch_funcs: list) -> None:
